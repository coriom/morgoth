"""Morgoth-authored data-feed tool: get_bitcoin_long_short_ratio.
...
_ENDPOINT_PATH = '/futures/data/globalLongShortAccountRatio?symbol=BTCUSDT&period=1h&limit=1'
_SOURCE_LABEL = 'fapi.binance.com'
_TOOL_DESCRIPTION = 'Fetch Binance global long/short account ratio for BTCUSDT perpetual futures, showing the fraction of trader accounts net long versus short as a directional sentiment gauge.'
_DIGEST_FIELDS = ['symbol', 'longShortRatio', 'longAccount', 'shortAccount', 'timestamp']


class GetBitcoinLongShortRatioTool(BaseTool):
    __doc__ = _TOOL_DESCRIPTION

    name = 'get_bitcoin_long_short_ratio'
    is_data_source = True
    ...
    api_endpoints = ('fapi.binance.com/futures/data/globallongshortaccountratio',)
